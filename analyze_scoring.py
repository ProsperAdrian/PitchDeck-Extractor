...
- Never award 10/10 unless the content is clear, complete, adequate for the startup and convincing.
- You MUST include a brief reason for each score (1 sentence max). Use the key `"comment"` for it. Ensure it relates to the specific business and what is on the deck.
